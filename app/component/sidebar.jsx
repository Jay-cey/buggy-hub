...
const Sidebar = () => {
  return (
    <div className="h-full w-[20%] fixed col-span-3 flex-start top-0 left-0">
        <aside className="w-full bg-white h-full border-r px-10 py-6 flex flex-col space-y-8 z-30 justify-around">
            ...
            <div className="flex flex-col space-y-6">
              <Link href={'/main'} className="space-x-3 text-sm text-[#796FAB] flex items-center font-bold">
              ...
              <Link href={'/signin'} className="space-x-3 text-xs">
